...
public class SimpleJDBC_DataSource {
  public static void main(String[] args)
    throws SQLException, ClassNotFoundException {
	  System.out.println("Output from SimpleJDBC_DataSource:   Using an implicit driver load via a MySQLDataSource object.");
	...
	dataSource.setPassword("coryn22");
