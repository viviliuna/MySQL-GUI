...
//
//
//public class AccountantApplication extends JFrame
//{
//    // default query retrieves all data from bikes table
//    static final String DEFAULT_QUERY = "SELECT * FROM operationscount";
//
//    private ResultSetTableModelAccountant tableModel;
...
//    public AccountantApplication()
//    {
//        super( "SQL ACCOUNTANT APPLICATION" );
//
//        // create ResultSetTableModel and display database table
//        try
//        {
//            // create TableModel for results of query SELECT * FROM bikes
//            tableModel = new ResultSetTableModelAccountant( DEFAULT_QUERY );
//
...
//
//            // new change 8
//            JScrollPane scrollPane2 = new JScrollPane(jTable); // Create a JScrollPane for jTable
...
//            String[] propertyFiles = {"operationslog.properties"};
...
//            String[] userProperties = {"theaccountant.properties"};
...
//                                "jdbc:mysql://localhost:3306/operationslog", "root", "coryn22"
//                        );
//                        tableModel = new ResultSetTableModelAccountant(connection, queryArea.getText());
//
////                        String query = "SELECT * FROM operationscount";
////                        ResultSetTableModelAccountant tableModel = new ResultSetTableModelAccountant(connection, query);
...
//                    resultTable.setModel(new DefaultTableModel());  // Clear the table by resetting the model
//                    queryArea.setText("");  // Clear the query area
//                }
//            });
//
